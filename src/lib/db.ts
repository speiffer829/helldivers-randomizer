...
export const primaryWeapons: PrimaryWeaponType[] = [
	...
	},
	{
		...
		category: 'Special',
		description: 'A flamethrower that can be used to set targets ablaze.',
		damage: 375,
		capacity: 80,
		recoil: 2,
...
export const secondaryWeapons: SecondaryWeaponType[] = [
	...
	},
	{
		...
		capacity: 6,
		recoil: 6,
		traits: ['Stimulative', 'One Handed', 'Rounds Reload'],
		image: 'stim-pistol.webp',
	},
	{
